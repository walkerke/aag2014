...
ggsave(file = "assets/img/chicago.png", plot = cplot, width = 11.5, height = 8)
...
ggsave(file = "assets/img/tampa.png", plot = tplot, width = 11.5, height = 8)


# dat.dc <- dat[dat$metroid == 47900,]
# 
# sub.dc <- dat.dc[dat.dc$boomergro < 200, ]
# 
# dc.diff <- ggplot(dat.dc, aes(distmiles, boomerdiff))
# 
# dcplot <- dc.diff + 
#   geom_point() + 
#   stat_smooth() + 
